package ec.app.gpevolve.lc.cipher;

import ec.app.gpevolve.lc.Helper;
...
public class HeysCipher {
	...
	public static double[][] LAT = Helper.generateLinearTable();
	public static double[][] DDT = Helper.generateDifferentialTable();
